	...
	<div class="mrb-setup__card">
		...
		<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="mrb-setup__body mrb-form" id="mrb-setup-form">
			...
			<?php elseif ( 2 === $step ) : ?>
				...
				<div class="mrb-setup__choices">
					<label class="mrb-choice">
						<input type="radio" name="hour_format" value="12" <?php checked( (string) ( $settings['hour_format'] ?? '12' ), '12' ); ?> />
						<strong><?php esc_html_e( '۱۲ ساعته', 'mr-booking' ); ?></strong>
						<span><?php esc_html_e( 'مثلاً ۴:۱۵ ب.ظ', 'mr-booking' ); ?></span>
					</label>
					<label class="mrb-choice">
						<input type="radio" name="hour_format" value="24" <?php checked( (string) ( $settings['hour_format'] ?? '12' ), '24' ); ?> />
						...
						<article class="mrb-setup__service-card" data-index="1">
							...
							<div class="mrb-setup__service-card__fields">
								...
								<label class="mrb-setup__field mrb-price-field-wrap<?php echo empty( $settings['show_prices'] ) ? ' is-hidden' : ''; ?>">
									...
									<input type="text" name="new_service_price[]" value="" inputmode="numeric" dir="ltr" data-mrb-money class="mrb-price-field" placeholder="<?php esc_attr_e( 'اختیاری', 'mr-booking' ); ?>" />
