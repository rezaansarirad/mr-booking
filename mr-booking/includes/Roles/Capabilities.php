...
final class Capabilities {
	...
	public const ACCOUNTING       = 'mr_booking_accounting';
	public const WALKIN           = 'mr_booking_walkin';
	...
	public static function page_caps(): array {
		return array(
			...
			'mr-booking-accounting'    => self::ACCOUNTING,
	...
	public static function sections(): array {
		return array(
			...
			self::WALKIN         => array(
				'label' => __( 'مراجعه حضوری', 'mr-booking' ),
				'desc'  => __( 'ثبت سریع مشتری حضوری بدون انتخاب تاریخ و ساعت', 'mr-booking' ),
				'cap'   => self::WALKIN,
			),
			self::CALENDAR       => array(
			...
			self::ACCOUNTING     => array(
				'label' => __( 'حسابداری', 'mr-booking' ),
				'desc'  => __( 'درآمد روزانه/ماهانه و گزارش مالی خدمات', 'mr-booking' ),
				'cap'   => self::ACCOUNTING,
			),
			self::SETTINGS       => array(
	...
	public static function admin_post_caps(): array {
		return array(
			...
			'mr_booking_quick_price'        => self::SERVICES,
			'mr_booking_wallet_adjust'      => self::CUSTOMERS,
