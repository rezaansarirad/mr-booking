...
final class Settings {
	...
	public static function defaults(): array {
		...
		return array_merge(
			...
			'color_card'              => '#FFFFFF',
			'color_border'            => '#D1E7E3',
			'color_holiday'           => '#DC2626',
			'color_holiday_bg'        => '#FEE2E2',
			'color_available'         => '#0F766E',
			'color_unavailable'       => '#94A3B8',
			'color_fully_booked'      => '#EA580C',
			'color_success'           => '#16A34A',
			'color_error'             => '#DC2626',
			'color_warning'           => '#D97706',
			'font_family'             => 'vazirmatn',
			'bg_gradient_enabled'     => 1,
			'color_bg_gradient_primary' => '#0F766E',
			'color_bg_gradient_accent'  => '#F59E0B',
			'bg_gradient_primary_mix' => 12,
			'bg_gradient_accent_mix'  => 10,
